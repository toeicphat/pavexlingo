...
export const ListeningIntenseIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path d="M13.1807 11.8606C12.7807 11.8606 12.4207 11.6406 12.2507 11.2806L10.8007 8.39058L10.3807 9.17058C10.1507 9.60058 9.6907 9.87058 9.2007 9.87058H8.4707C8.0607 9.87058 7.7207 9.53058 7.7207 9.12058C7.7207 8.71058 8.0607 8.37058 8.4707 8.37058H9.1107L9.9007 6.91058C10.0907 6.57058 10.4707 6.34058 10.8307 6.36058C11.2207 6.36058 11.5707 6.59058 11.7507 6.93058L13.1807 9.79058L13.5207 9.10058C13.7507 8.64058 14.2007 8.36058 14.7207 8.36058H15.5307C15.9407 8.36058 16.2807 8.70058 16.2807 9.11058C16.2807 9.52058 15.9407 9.86058 15.5307 9.86058H14.8207L14.1107 11.2706C13.9307 11.6406 13.5807 11.8606 13.1807 11.8606Z" fill="currentColor"/>
        <path d="M2.74982 18.6508C2.33982 18.6508 1.99982 18.3108 1.99982 17.9008V12.2008C1.94982 9.49078 2.95982 6.93078 4.83982 5.01078C6.71982 3.10078 9.23982 2.05078 11.9498 2.05078C17.4898 2.05078 21.9998 6.56078 21.9998 12.1008V17.8008C21.9998 18.2108 21.6598 18.5508 21.2498 18.5508C20.8398 18.5508 20.4998 18.2108 20.4998 17.8008V12.1008C20.4998 7.39078 16.6698 3.55078 11.9498 3.55078C9.63982 3.55078 7.49982 4.44078 5.90982 6.06078C4.30982 7.69078 3.45982 9.86078 3.49982 12.1808V17.8908C3.49982 18.3108 3.16982 18.6508 2.74982 18.6508Z" fill="currentColor"/>
        <path d="M5.94 12.4492H5.81C3.71 12.4492 2 14.1592 2 16.2592V18.1392C2 20.2392 3.71 21.9492 5.81 21.9492H5.94C8.04 21.9492 9.75 20.2392 9.75 18.1392V16.2592C9.75 14.1592 8.04 12.4492 5.94 12.4492Z" fill="currentColor"/>
        <path d="M18.19 12.4492H18.06C15.96 12.4492 14.25 14.1592 14.25 16.2592V18.1392C14.25 20.2392 15.96 21.9492 18.06 21.9492H18.19C20.29 21.9492 22 20.2392 22 18.1392V16.2592C22 14.1592 20.29 12.4492 18.19 12.4492Z" fill="currentColor"/>
    </svg>
);
export const BubbleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg viewBox="0 0 1024 1024" fill="currentColor" {...props}>
    <path d="M718.08 416a32 32 0 0 0-42.88 14.72A184.96 184.96 0 0 1 512 544c-107.52 0-192-108.48-192-247.36C320 115.52 454.4 96 512 96a32 32 0 0 0 0-64c-157.76 0-256 101.44-256 264.64 0 144.96 77.44 263.36 185.92 299.52L416 696.32A32 32 0 0 0 448 736h78.4a412.8 412.8 0 0 1-36.8 41.28c-47.04 47.04-10.24 124.16-6.08 132.8l32 64a32 32 0 0 0 57.28-28.48l-32-64c-7.68-15.68-16.32-48.64-6.08-59.2 54.4-54.4 78.72-96 72.32-124.8l-24.96-99.84a261.12 261.12 0 0 0 150.72-139.2 32 32 0 0 0-14.72-42.56z m-183.04 256h-46.08l16-64h14.08zM747.84 180.16a32 32 0 1 0-59.52 23.36A256 256 0 0 1 704 296.64v21.44a32 32 0 0 0 29.44 33.92H736a32 32 0 0 0 32-30.08v-25.28a320 320 0 0 0-20.16-116.48zM627.84 125.12a32 32 0 0 0 41.6-41.92 37.44 37.44 0 0 0-6.72-10.56 32 32 0 0 0-45.44 0A33.6 33.6 0 0 0 608 96a32 32 0 0 0 9.28 22.72 38.08 38.08 0 0 0 10.56 6.4z" />
    <path d="M499.52 224a32 32 0 1 0-10.56-64C423.04 173.12 384 227.84 384 308.48a212.16 212.16 0 0 0 26.56 105.6 32 32 0 1 0 55.36-32 148.48 148.48 0 0 1-17.92-73.6c0-34.24 8.96-76.16 51.52-84.48z" />
  </svg>
);

export const GamepadIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 6.087c0-.355.186-.676.401-.959.221-.29.349-.634.349-1.003 0-1.036-1.007-1.875-2.25-1.875s-2.25.84-2.25 1.875c0 .369.128.713.349 1.003.215.283.401.604.401.959v0a.64.64 0 01-.657.643 48.39 48.39 0 01-4.163-.3c.186 1.613.293 3.25.315 4.907a.656.656 0 01-.658.663v0c-.355 0-.676-.186-.959-.401a1.647 1.647 0 00-1.003-.349c-1.036 0-1.875 1.007-1.875 2.25s.84 2.25 1.875 2.25c.369 0 .713-.128 1.003-.349.283-.215.604-.401.959-.401v0c.31 0 .575.27.592.58.12 2.228.354 4.426.69 6.577.017.108.113.187.223.187h12.443c.11 0 .206-.079.223-.187.336-2.151.57-4.349.69-6.577.017-.31.282-.58.592-.58v0c.355 0 .676.186.959.401.29.221.634.349 1.003.349 1.036 0 1.875-1.007 1.875-2.25s-.84-2.25-1.875-2.25c-.369 0-.713.128-1.003.349-.283.215-.604.401-.959.401v0a.656.656 0 01-.658-.663 48.422 48.422 0 00-.315-4.907c-.02-.184.127-.341.313-.341h.001c.21 0 .416-.017.618-.049a18.3 18.3 0 00-4.163.301c-.3.023-.55-.205-.55-.506v0z" />
  </svg>
);

export const FlappyBirdIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg height="1em" width="1em" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" xmlSpace="preserve" {...props}>
<g>
	<path fill="#F5E038" d="M495.432,221.797H307.307c0,51.949,42.113,94.063,94.063,94.063
		C453.319,315.858,495.432,273.746,495.432,221.797z"/>
	<path fill="#F5E038" d="M16.568,221.797h188.125c0,51.949-42.113,94.063-94.063,94.063
		C58.681,315.858,16.568,273.746,16.568,221.797z"/>
</g>
<path fill="#F9C900" d="M102.079,264.552c0-85.008,68.913-230.881,153.921-230.881s153.921,145.873,153.921,230.881
	S341.008,418.473,256,418.473S102.079,349.56,102.079,264.552z"/>
<path fill="#F9AA0C" d="M307.307,375.716c-85.008,0-153.921-68.913-153.921-153.921c0-53.02,26.81-129.713,67.61-179.927
...
<circle fill="#FFFFFF" cx="315.858" cy="187.591" r="17.102"/>
<circle fill="#F1EDE8" cx="196.142" cy="187.591" r="17.102"/>
<polygon fill="#EA802C" points="256,256.001 221.795,221.797 290.205,221.797 "/>
