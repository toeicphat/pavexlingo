...
const announcements = [
  { date: '08/08/2026', time: '16:00', text: 'Thay đổi giao diện Reading và bộ sung 100 câu chuyên sâu Reading Part 5' },
  { date: '06/08/2026', time: '16:00', text: 'Bổ sung chế độ game Word Rain trong giao diện luyện từ vựng' },
